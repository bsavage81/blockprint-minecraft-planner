...
- Local texture IDs audited: 1808
- State-sensitive gaps: 59
...
| `minecraft:sculk_sensor` | `sculk_sensor_phase` | active/inactive tendrils | inactive: sculk_sensor_tendril_inactive; active: sculk_sensor_tendril_active |
...
| `minecraft:waxed_copper_bulb` | `lit` | lit/unlit bulb | lit: waxed_copper_bulb_lit / waxed_copper_bulb_on |
...
| `minecraft:waxed_exposed_copper_bulb` | `lit` | lit/unlit bulb | lit: waxed_exposed_copper_bulb_lit / waxed_exposed_copper_bulb_on |
...
| `minecraft:waxed_oxidized_copper_bulb` | `lit` | lit/unlit bulb | lit: waxed_oxidized_copper_bulb_lit / waxed_oxidized_copper_bulb_on |
...
| `minecraft:waxed_weathered_copper_bulb` | `lit` | lit/unlit bulb | lit: waxed_weathered_copper_bulb_lit / waxed_weathered_copper_bulb_on |
